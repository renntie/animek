...
export default function LatestPage() {
  ...
  const fetchFn = useCallback(() => getLatest(page), [page])
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-white">Anime Terbaru</h1>
        </div>
        <p className="text-gray-500 text-sm ml-4">Episode terbaru yang baru saja rilis</p>
      </div>
